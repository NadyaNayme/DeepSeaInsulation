...
/***/ "./asset/data/electrified.data.png":
/*!*****************************************!*\
  !*** ./asset/data/electrified.data.png ***!
  \*****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports=(__webpack_require__(/*! alt1/base */ "../node_modules/alt1/dist/base/index.js").ImageDetect.imageDataFromBase64)("")
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   startDeepSeaInsulation: () => (/* binding */ startDeepSeaInsulation)
/* harmony export */ });
...
var debuffs = new (alt1_buffs__WEBPACK_IMPORTED_MODULE_5___default())();
...
var alert = new Audio(alarms[_a1sauce__WEBPACK_IMPORTED_MODULE_0__.getSetting('alert')]);
alert.pause();
function playAlert() {
    alert.volume = Number(_a1sauce__WEBPACK_IMPORTED_MODULE_0__.getSetting('volume')) / 100;
    alert.currentTime = 0;
    alert.play();
}
function pausealert() {
...
var debuffImages = alt1__WEBPACK_IMPORTED_MODULE_6__.webpackImages({
    electrified: __webpack_require__(/*! ./asset/data/electrified.data.png */ "./asset/data/electrified.data.png"),
});
function startDeepSeaInsulation() {
    if (!window.alt1) {
...
function findElectrocution(debuffs) {
    var foundDebuff = false;
    if (alt1.rsActive) {
        alt1.clearTooltip();
        pausealert();
    }
    else {
        for (var _i = 0, _a = Object.entries(debuffs); _i < _a.length; _i++) {
            var _b = _a[_i], _key = _b[0], value = _b[1];
            var electrified = value.countMatch(debuffImages.electrified, false);
        ...
        if (currentStacks && currentStacks > lastStacks && alert.paused) {
            if (_a1sauce__WEBPACK_IMPORTED_MODULE_0__.getSetting('showTooltip')) {
                alt1.setTooltip("You were shocked! Current Stacks: ".concat(currentStacks));
            }
            playAlert();
        }
...
function initSettings() {
    ...
    var dropdown = getByID('Alert');
    dropdown.value = _a1sauce__WEBPACK_IMPORTED_MODULE_0__.getSetting('alert');
    ...
    audioFileSelectors.forEach(function (fileSelector) {
        fileSelector.addEventListener('change', function () {
            _a1sauce__WEBPACK_IMPORTED_MODULE_0__.updateSetting(fileSelector.dataset.setting, fileSelector.value);
        });
    });
}
function setDefaultSettings() {
...
var settingsObject = {
    ...
    tooltip: _a1sauce__WEBPACK_IMPORTED_MODULE_0__.createCheckboxSetting('showTooltip', 'Enable mouse tooltip with alarm', false),
};
